...
def parse_args():
    ...
    parser.add_argument("--checkpoint_path", "-c", type=str, required=True, help="Path to the checkpoint to merge. Must end with .pt and be colocated with the sharded checkpoints ending in _model_mp_{rank}.pt")
...
if __name__ == "__main__":
    args = parse_args()
    merge_sharded_checkpoints(args.checkpoint_path, args.output_path, args.tensor_parallel_size, args.model_size, args.model_family)
