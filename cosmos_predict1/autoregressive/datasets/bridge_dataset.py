...
PYTHONPATH=. python cosmos_predict1/autoregressive/datasets/bridge_dataset.py
...
from cosmos_predict1.autoregressive.configs.base.dataset import BridgeDatasetConfig
...
class BridgeDataset(Dataset):
    def __init__(self, config: BridgeDatasetConfig):
        """Bridge Dataset class for loading image-text-to-video generation data.
        ...
        self.video_dir = os.path.join(self.dataset_dir, "video")
