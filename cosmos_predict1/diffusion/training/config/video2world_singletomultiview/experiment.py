...
from cosmos_predict1.diffusion.training.models.view_extend_model_multiview import FSDPExtendDiffusionModel
...
video2world_singletomultiview_7b_example_waymo = LazyDict(
    dict(
        defaults=[
        ...
        job=dict(
            ...
            name="video2world_singletomultiview_7b_example_waymo",
        ),
        optimizer=dict(
        ...
        checkpoint=dict(
            save_iter=200,
            load_path="checkpoints/Cosmos-Predict1-7B-Video2World-Sample-AV-SingleToMultiView/v2w_model.pt",
        ...
        model=dict(
            ...
            net=L(MultiviewExtensionGeneralDIT)(
                ...
                n_views=train_num_views,
                n_views_emb=num_views_embedding,
            ...
            conditioner=dict(
                video_cond_bool=dict(
                    condition_location="first_cam_and_random_n",
...
def register_experiments(cs):
    ...
    for _item in [
        video2world_singletomultiview_7b_example_waymo,
    ]:
